...
postsApiRouter.get('/:username', function (req, res) {
...
// PUT /api/posts/:username
postsApiRouter.put('/:username', function (req, res) {
...
// DELETE /api/posts/:username
postsApiRouter.delete('/:username', function (req, res) {
    if (req.user.isAdmin || req.user.username === req.params.username) {
        userController.getUserByUsername(req.params.username, function (err, user) {
